    ...
    <>
      ...
      <Header src="joker1">
        ...
        <Header.Feature>
          ...
          <Header.Text>
            Forever alone in a crowed, failed comedian Authutr Flecj seeks
            connection as he walks the streetsof Gothan City. Authur wears two
            masks -- the one he paints for his day job as a clown, and guise he
            projects.
          </Header.Text>
            ...
            <Card.Entities>
              {item?.data?.map((ent) => (
                <Card.Item key={ent.docId} item={ent}>
                  <Card.Image
                    onClick={() => handleClick(ent.title)}
                    src={`/images/${category}/${ent.genre}/${ent.slug}/small.jpg`}
                    alt={ent.title}
                  />
                  <Card.Meta>
